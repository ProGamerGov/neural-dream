...
* `-use_redirected_relu`: Enabling this flag will replace every ReLU layer with the [RedirectedReLU layer from Lucent](https://github.com/greentfrapp/lucent/blob/master/lucent/modelzoo/inceptionv1/helper_layers.py).
